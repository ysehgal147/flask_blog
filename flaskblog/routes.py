...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash("Unsuccessful Login! Check Your Details", 'danger')
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', sender='donotreply@mail.com', recipients=[user.email])
    msg.body = f'''
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('Email sent for password recovery', 'info')
        return redirect(url_for('login'))
